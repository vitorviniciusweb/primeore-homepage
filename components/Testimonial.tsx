...
export default function Testimonial() {
  return (
    <section className="py-12 md:py-20 bg-background-soft border-t border-b border-foreground/5">
      <div className="container mx-auto px-4 md:px-6 max-w-4xl">
        ...
        >
          ...
          <div className="mt-5 flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4 px-1">
